...
# ---- Sample Data ----
# Replace this with your own df = pd.read_csv(...) or however you load data
data = [
    {"Date": "2025-05-29", "Gross Revenue": 14, "eCPM": 4.54, "Fill Rate": 8.75},
    {"Date": "2025-05-30", "Gross Revenue": 622, "eCPM": 4.74, "Fill Rate": 24.1},
]
...
# ---- Trend graph REMOVED ----
# If you had a line_chart here, it has been removed as requested.

# ---- Optionally: Add divider ----
st.markdown("---")
